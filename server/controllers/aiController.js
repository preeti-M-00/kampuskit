  ...
  try {
    ...
    Provide data in the following JSON format with no additional text before or after: 
    {
        ...
        experience: [
        {
            ...
            start_date: {type: String, format: "YYYY-MM, e.g. 2023-06"},
            end_date: {type: String, format: "YYYY-MM, e.g. 2024-01. Empty string if current"},
        ...
        education: [
        {
            ...
            degree: {type:String},
            field: {type: String},
            graduation_date: {type: String, format: "YYYY-MM, e.g. 2026-05. Use month 05 if only year is available"},
            gpa: {type: String}
        }]
    }
    `;
